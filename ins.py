...
class CRD:
    ...
    def installCRD():
        ...
        subprocess.run(['apt', 'install', '--assume-yes', 'xvfb', 'xserver-xorg-video-dummy', 'xbase-clients', 'python3-packaging', 'python3-psutil', 'python3-xdg', 'libutempter0', 'libxtst6'])
...
subprocess.run(['apt', 'install', '--assume-yes', 'firefox'])
